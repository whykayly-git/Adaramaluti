...
import { ShippingRatesForm } from "@/components/admin/settings/ShippingRatesForm";
  ...
  return (
    <AdminShell activePath="/admin/settings">
      ...
      <p className="mt-1 text-sm text-gray-500">
        Brand details shown across the site, checkout shipping rates, and the Shipping & Returns,
        Privacy Policy, Terms of Service and Contact page content.
      </p>
      ...
      <h2 className="mt-10 font-bold text-xl text-primary">Checkout</h2>
      <div className="mt-4">
        <ShippingRatesForm initial={shippingOptions} />
      </div>
